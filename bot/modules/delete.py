...
delete_handler = CommandHandler(command=BotCommands.Delete2Command, callback=deletefile, filters=CustomFilters.owner_filter | CustomFilters.sudo_user, run_async=True)
