...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg = f"/{BotCommands.Watch2Command} [youtube-dl supported link] [quality] |[CustomName] to mirror with youtube-dl.\n\n"
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.Watch2Command} https://youtu.be/Pk_TthHfLeE 720 |Slam</code>\n\n"
...
mirror_handler = CommandHandler(BotCommands.Watch2Command, watch,
                                filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True)
tar_mirror_handler = CommandHandler(BotCommands.TarWatch2Command, watchTar,
                                    filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True)
